...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "uslugi.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/uslugi.css?crc=3931901686" id="pagesheet"/>
 ...
 <body>
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="clearfix colelem" id="pu123-4"><!-- group -->
    ...
    <a class="nonblock nontext MuseLinkActive clearfix grpelem" id="u141-4" href="uslugi.php"><!-- content --><p id="u141-2">Услуги</p></a>
   ...
   <div class="colelem" id="u582"><!-- simple frame --></div>
   <?php
$connect = mysqli_connect(HOST,USER,PASSWORD,DB);
if(!$connect) exit('Ошибка подключения к БД');
$query = mysqli_query($connect,'SELECT * FROM `uslugi` ORDER BY `id` DESC');
while($row = mysqli_fetch_assoc($query)){ 
   echo '<div class="clearfix colelem" id="u620">';
   echo  '<div class="clearfix colelem" id="u602-4">';
   echo   '<a href="/page?table=uslugi&id=',"$row[id]",'">',"$row[title]",'</a>';
   echo   '</div>';
