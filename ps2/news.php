  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pu123-4"><!-- group -->
     ...
     <a class="nonblock nontext MuseLinkActive clearfix grpelem" id="u135-4" href="news.php"><!-- content --><p id="u135-2">Новости</p></a>
    ...
    <div class="clearfix colelem" id="u563-4"><!-- content -->
     <p>Новости</p>
    </div>
...
while($row = mysqli_fetch_assoc($query)){ 
   ...
   echo   "<a href='/page?table=news&id=$row[id]'>","$row[title]","</a>";
   echo   '</div>';
    echo '<div class="clip_frame colelem" id="u608">';
    echo '<img class="block" id="u608_img" src="images/news/',"$row[photo]",'?crc=4252155979" alt="" width="442" height="332"/>';
    echo '</div>';
