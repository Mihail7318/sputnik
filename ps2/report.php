...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "report.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/report.css?crc=3885465962" id="pagesheet"/>
   </head>
 <body>
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="clearfix colelem" id="pu123-4"><!-- group -->
    ...
    <a class="nonblock nontext MuseLinkActive clearfix grpelem" id="u144-4" href="report.php"><!-- content --><p id="u144-2">Обратная связь</p></a>
   </div>
   ...
   <div class="clearfix colelem" id="pu594"><!-- group -->
    <div class="grpelem" id="u594"><!-- simple frame --></div>
    <div class="clearfix grpelem" id="u655"><!-- column -->
     <div class="clearfix colelem" id="pu686-4"><!-- group -->
      <div class="clearfix grpelem" id="u686-4"><!-- content -->
       <p id="u686-2">Имя отправителя</p>
      </div>
      <div class="grpelem" id="u674"><!-- simple frame --></div>
     </div>
     <div class="clearfix colelem" id="pu689-4"><!-- group -->
      <div class="clearfix grpelem" id="u689-4"><!-- content -->
       <p id="u689-2">E-mail отправителя</p>
      </div>
      <div class="grpelem" id="u677"><!-- simple frame --></div>
     </div>
     <div class="clearfix colelem" id="pu692-4"><!-- group -->
      <div class="clearfix grpelem" id="u692-4"><!-- content -->
       <p id="u692-2">Тема письма</p>
      </div>
      <div class="grpelem" id="u680"><!-- simple frame --></div>
     </div>
     <div class="clearfix colelem" id="pu695-4"><!-- group -->
      <div class="clearfix grpelem" id="u695-4"><!-- content -->
       <p id="u695-2">Текст сообщения</p>
      </div>
      <div class="grpelem" id="u681"><!-- simple frame --></div>
     </div>
     <div class="clearfix colelem" id="u704-4"><!-- content -->
      <p id="u704-2">Отправить</p>
     </div>
    </div>
   </div>
   <div class="verticalspacer" data-offset-top="1495" data-content-above-spacer="1493" data-content-below-spacer="41"></div>
  </div>
  <!-- Other scripts -->
  <script type="text/javascript">
