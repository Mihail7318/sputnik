...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "document.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/document.css?crc=3766455888" id="pagesheet"/>
  <link rel="stylesheet" type="text/css" href="css/news.css?crc=4273386714" id="pagesheet"/>
   </head>
 <body>
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="clearfix colelem" id="pu123-4"><!-- group -->
    ...
    <a class="nonblock nontext MuseLinkActive clearfix grpelem" id="u138-4" href="document.php"><!-- content --><p id="u138-2">Документы</p></a>
   ...
   <div class="clearfix colelem" id="u587-4"><!-- content -->
    <p>Нормативные правовые документы</p>
   </div>
   <div class="colelem" id="u588"><!-- simple frame --></div>
   <?php
$connect = mysqli_connect(HOST,USER,PASSWORD,DB);
if(!$connect) exit('Ошибка подключения к БД');
$query = mysqli_query($connect,'SELECT * FROM `document` ORDER BY `id` DESC');
while($row = mysqli_fetch_assoc($query)){ 
   echo '<div class="clearfix colelem" id="u620">';
   echo  '<div class="clearfix colelem" id="u602-4">';
   echo   '<a href="/page?table=document&id=',"$row[id]",'">',"$row[title]",'</a>';
   echo   '</div>';
   // echo  '<div class="colelem" id="u623"></div>';
    echo '<div class="clearfix colelem" id="u605-22">';
    echo $row['preload'];  ;
     echo "</br>";
     echo "</br>";
    echo $row['date'];
   echo  '</div>';
    '</div>';
  //echo '<div class="verticalspacer" data-offset-top="1508" data-content-above-spacer="1507" data-content-below-spacer="40"></div>';
...
?>
   <div class="verticalspacer" data-offset-top="439" data-content-above-spacer="439" data-content-below-spacer="338"></div>
  </div>
  <!-- Other scripts -->
  <script type="text/javascript">
