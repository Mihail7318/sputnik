...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "information.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/information.css?crc=439277623" id="pagesheet"/>
   </head>
 <body>
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="clearfix colelem" id="pu123-4"><!-- group -->
    ...
    <a class="nonblock nontext MuseLinkActive clearfix grpelem" id="u129-4" href="information.php"><!-- content --><p id="u129-2">Информация</p></a>
   ...
   <div class="clearfix colelem" id="u569-4"><!-- content -->
    <p>Иформация</p>
   </div>
   <div class="colelem" id="u570"><!-- simple frame --></div>
   <?php
$connect = mysqli_connect(HOST,USER,PASSWORD,DB);
if(!$connect) exit('Ошибка подключения к БД');
$query = mysqli_query($connect,'SELECT * FROM `information`');
while($row = mysqli_fetch_assoc($query)){ 
  echo '<div class="colelem" id="u599">';
  echo $row['Inform'];
  echo $row['date'];
  echo '</div>';
  }
?>
   <div class="verticalspacer" data-offset-top="996" data-content-above-spacer="996" data-content-below-spacer="87"></div>
  </div>
  <!-- Other scripts -->
  <script type="text/javascript">
