...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "anons.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="css/anons.css?crc=4068338558" id="pagesheet"/>
   </head>
 <body>
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pu123-4"><!-- group -->
     ...
     <a class="nonblock nontext MuseLinkActive clearfix grpelem" id="u132-4" href="anons.php"><!-- content --><p id="u132-2">Анонсы</p></a>
    ...
    <div class="colelem" id="u576"><!-- simple frame --></div>
   <?php
   $connect = mysqli_connect(HOST,USER,PASSWORD,DB);
if(!$connect) exit('Ошибка подключения к БД');
    $query = mysqli_query($connect,'SELECT * FROM `anons` ORDER BY `id` DESC');
while($row = mysqli_fetch_assoc($query)){ 

echo    '<div class="clearfix colelem" id="u627"><!-- column -->
     <div class="clearfix colelem" id="u628-4"><!-- content -->
      <a href="/page?table=anons&id=',"$row[id]",'">',"$row[title]",'</a>
     </div>
     <div class="clearfix colelem" id="pu747"><!-- group -->
      <div class="clip_frame grpelem" id="u747"><!-- image -->
       <img class="block" id="u747_img" src="images/anons/',"$row[photo]",'?crc=155637711" alt="" width="402" height="568"/>
      </div>
      <div class="clearfix grpelem" id="u756-4"><!-- content -->
       <p>',"$row[text]",'</p>
      </div>
     </div>
     <div class="clearfix colelem" id="u759-4"><!-- content -->
      <p>',"$row[date]",'</p>
     </div>
    </div>';
  }
    ?>
    <div class="verticalspacer" data-offset-top="1115" data-content-above-spacer="1114" data-content-below-spacer="40"></div>
   </div>
  </div>
  <!-- Other scripts -->
  <script type="text/javascript">
